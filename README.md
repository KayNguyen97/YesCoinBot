...
## [Settings](https://github.com/KayNguyen97/YesCoinBot/blob/main/.env-example)
| Настройка                | Описание                                                                               |
|--------------------------|----------------------------------------------------------------------------------------|
...
## Installation
You can download [**Repository**](https://github.com/KayNguyen97/YesCoinBot) by cloning it to your system and installing the necessary dependencies:
```shell
~ >>> git clone https://github.com/KayNguyen97/YesCoinBot.git
~ >>> cd YesCoinBot

# If you are using Telethon sessions, then clone the "converter" branch
~ >>> git clone https://github.com/KayNguyen97/YesCoinBot.git -b converter
~ >>> cd YesCoinBot
